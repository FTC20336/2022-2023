...
@Config
@Disabled
@Autonomous(name="Left_RR_MP", group="Left")
public class AutoUsingDetector_Left_RR_MP extends LinearOpMode {
    ...
    public static Vector2d coneStack = new Vector2d(-63, -12.5);
    public static Vector2d shortPole = new Vector2d(-49,-18);

    public static Vector2d p1 = new Vector2d(-40,-65); // Starting Point
    public static Vector2d p2 = new Vector2d(-13,-63.5); //
    public static Vector2d p3 = new Vector2d(-17,-23.5); // Right of the Medium Middle Junction
    public static Vector2d p4 = new Vector2d(-19, -23.5); // Align w pole
    public static Vector2d p5 = new Vector2d(-15,-23.75); //
    public static Vector2d p6 = new Vector2d(-14,  coneStack.getY() ); //
    ...
    public void runOpMode() {
        ...
        if (ParkingPos == BBBDetector_Color.ElementPosition.RIGHT) {
            ...
            BeepArm.ViperSlideSetPos(24, 11, 1);
