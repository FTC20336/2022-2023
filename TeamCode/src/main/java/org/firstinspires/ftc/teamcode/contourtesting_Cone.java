...
@Config
@Autonomous (name="contour Cone", group="Tutorials")

public class contourtesting_Cone extends LinearOpMode {
    ...
    public static double Kp =0;// 0.0004;
    ...
    public void runOpMode() {
        ...
        //OpenCV Pipeline
        BBBDetector_Contour_Cone myPipeline;
        webcam.setPipeline(myPipeline = new BBBDetector_Contour_Cone(CAMERA_WIDTH, CAMERA_HEIGHT,clawCenter,pixelMargin ));
